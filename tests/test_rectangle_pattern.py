...
def test_is_pattern_invalid_row():
    pattern = Rectangle({"top_left": Card(1,  {"top_left": Color.PINK, "top_right": Color.GRAY,
                         ...
                         "top_middle": Card(2,  {"top_left": Color.GREEN, "top_right": Color.YELLOW,
                                                 "bottom_left": Color.RED, "bottom_right": Color.PINK}),
                         "top_right": Card(3,  {"top_left": Color.GRAY, "top_right": Color.GRAY,
                                                "bottom_left": Color.BLUE, "bottom_right": Color.GRAY}),
                         "bottom_left": Card(4,  {"top_left": Color.GREEN, "top_right": Color.PINK,
                                                  "bottom_left": Color.BLUE, "bottom_right": Color.YELLOW}),
                         "bottom_middle": Card(5,  {"top_left": Color.GRAY, "top_right": Color.RED,
                                                    "bottom_left": Color.YELLOW, "bottom_right": Color.BLUE}),
                         "bottom_right": Card(6,  {"top_left": Color.YELLOW, "top_right": Color.PINK,
